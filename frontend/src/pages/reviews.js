...
import { CssBaseline, Box, ThemeProvider,Slide, Card, CardContent, Typography, Grid, Container, Stack, Hidden, Avatar, Badge, ImageList, ImageListItem } from '@mui/material';
                    ...
                    <Grid style={{width:'100%'}}>
                        <CardContent>
                            ...
                            <Grid container style={{margin:'30px auto 0px', justifyContent:'center'}}>
                                <Grid>
                                    <Typography sx={{fontSize: '24px', fontWeight: '700', color: '#FFCE00', lineHeight:'190%', paddingRight:'10px'}} component="div">{`${rating}점`}</Typography>
                                </Grid>
                                <Grid>
