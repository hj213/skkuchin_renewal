...
위의 규정에도 불구하고, 동 분쟁으로 인하여 소송이 제기될 경우 동 소송은 “스꾸친”의 본사소재지를 관할하는 대한민국 법원의 관할로 합니다.
  ...
  const backClick = () => {
    ...
    <ThemeProvider theme={theme}>
        <CssBaseline />
        {/* 상단 */}
        <Container style={{position: 'fixed', left: '0', right: '0', top: '0', padding:'0px', alignItems: 'center', paddingTop: '45px', paddingBottom: '10px', backgroundColor: 'white', maxWidth: '420px'}}> 
          <Grid container>
