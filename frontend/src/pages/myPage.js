            ...
            <div style={{display: 'grid', gridTemplateColumns: '72px 1fr 38px', alignItems: 'center', padding: '0 15px'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'column', marginLeft: '9px'}}>
                    ...
                    <div style={{display: 'flex'}}>
                        <Typography sx={{height: '16px', border: "1px solid #BABABA", fontSize: '10px', p: '0px 6.5px', borderRadius: '17px', marginTop:"-2px"}} color={theme.palette.fontColor.main}>{user.campus}</Typography>
