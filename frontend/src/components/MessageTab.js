  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'transparent',  backgroundColor:'white'}}>
        <Tabs variant="fullWidth" value={value} onChange={handleChange} aria-label="basic tabs example" sx={{position: 'fixed',width:'100%', pt: '15px', backgroundColor:'white', maxWidth: '420px', zIndex: '10'}}>
