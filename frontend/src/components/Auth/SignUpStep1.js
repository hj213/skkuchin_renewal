    ...
    return (
        ...
        <form style={{ width: '100%'}}>
            <div style={{margin: '0 36px'}}>
                ...
                required
                InputProps={{
                    endAdornment: (validUsername) ? <Image src={check} width={15.83} height={15.83} sx={{p: '1.58px', mb: '5.58px'}}/> : null 
                }}
                />
                {/* 중복확인 메소드 추가 */}
            ...
            <div style={{margin: '0 36px'}}>
                ...
                : <Typography sx={{fontSize: '9px', fontWeight: '500', color: '#505050', mt: '6px', mb: '25px'}}>영문, 숫자, 특수문자를 포함한 8~16자 조합으로 입력해주세요.</Typography> }
            </div>
            <div style={{margin: '0 36px'}}>
                <TextField
                variant="standard"
