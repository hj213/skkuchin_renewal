...
public class ReviewServiceTest extends MockTest {
    ...
    public void getAll_성공() {
        //given
        Review review1 = new Review(1L, 5.0F, "맛있어요", place, user, null, null, null);
        Review review2 = new Review(2L, 4.5F, "맛있네용~", place, user, null, null, null);
    ...
    public void getDetail_성공() {
        //given
        Review review = new Review(1L, 3.0F, "보통입니다", place, user, null, null, null);
    ...
    public void update_성공() {
        ...
        Review existingReview = new Review(1L, 4.5F, "맛있다", place, user, null, null, null);
    ...
    public void update_다른_유저가_리뷰_수정_시도_오류() {
        //given
        ReviewDto.PutRequest dto = new ReviewDto.PutRequest(5.0F, "굿!", null, null);
        Review review = new Review(1L, 5.0F, "맛있어요", place, user, null, null, null);
    ...
    public void delete_성공() {
        //given
        Review review = new Review(1L, 4.0F, "또 갈래요", place, user, null, null, null);
    ...
    public void getUserReview_성공() {
        ...
        AppUser user2 = AppUser.builder()
                ...
                .build();
        Review review1 = new Review(1L, 4.0F, "또 갈래요", place, user, null, null, null);
        Review review2 = new Review(2L, 5.0F, "짱", place, user2, null, null, null);
